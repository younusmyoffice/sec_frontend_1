...
import img from "../../../../constants/DrImages/image 27.png"
import CustomButton from "../../../../components/CustomButton";

const steps = ["Date", "Payment Method", "Scanner", "Result"];

export default function HCFStepper() {
                        ...
                        {activeStep === 0 ? (
                            ...
                            <>
                                <Box sx={{ display: "flex", flexDirection: "column",height:"300px" }}>
                                   <CustomButton buttonCss={{display:"block",margin:"auto"}} label="Proceed to pay"/>
                                </Box>
                            </>
                        ) : activeStep === 2 ? (
                            <>
                                <Box>
                                    <Box sx={{ display: "flex", flexDirection: "column" }}>
                                       <img src={img} style={{width:"300px",height:"300px",display:"block",margin:"auto"}}/>
                                    </Box>
                                </Box>
                            </>
                        ) : activeStep === 3 ? (
                            <>
                                    <Box sx={{ display: "flex", flexDirection: "column",height:"300px"}}>
                                     <h1>Condition</h1>
                                     <p>Payment Successful or Failed</p>
                                    </Box>
