                ...
                <React.Fragment>
                    ...
                    <Box sx={{displa : "flex" , justifyContent : "center" , textAlign : "center"}}>
                        <Typography sx={{
                            ...
                            fontWeight: "600",
                            lineHeight: "1.5rem",
                        }} >Appointment Canceled</Typography>
                        <Typography sx={{
                            fontFamily: "Poppins",
                            fontSize: "0.875rem",
                            fontStyle: "normal",
                        ...
                        {activeStep === 0 ? (
                            <>
                                <Box sx={{ width: "100%"}}>
                                    ...
                                    Note : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ut tellus quis sapien interdum commodo. Nunc tincidunt justo non dolor bibendum,
                                    </Typography>
                                    <Box sx={{  display : "flex" , 
