                                ...
                                currentData.map((data) => (
                                    <UpcomingCard
                                        ...
                                        path={{
                                            ...
                                            join: data?.plan_name === 'video' ? `/videocallingsdk/${data?.appointment_id}` : 
                                            data?.plan_name === 'message' ?   `/patientdashboard/appointment/chats/${data.first_name}/${data.roomid}/${data?.appointment_id}` : null,
                                        }}
                                        DrImage={data.profile_picture || DrImage}
                                        label=""
                                        isDisabled={data?.join_status === 0}
