...
const CustomList = ({ items, handleToggle, showDescription, showAvatar, maxWidth }) => {
    return (
                        ...
                        <ListItemButton>
                            ...
                            <ListItemText
                                ...
                                secondary={
                                    showDescription ? (
                                        <Fragment>
                                            I will be in your neighborhood doing errands this. I
                                            will be in your neighborhood doing errands this…
                                        </Fragment>
                                    ) : null
                                }
                            />
