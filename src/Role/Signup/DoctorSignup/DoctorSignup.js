                                        ...
                                        <div className="mainBox1">
                                            <Box sx={{ width: "40%" }}>
                                                ...
                                                <div className="Date-of-birth1">
                                                    <CustomDatePicker
                                                        label="Date of Birth"
                                                        value={updateUserData.DOB ? new Date(updateUserData.DOB) : null}
                                                        onChange={(value) => {
                                                            if (value) {
                                            ...
                                            <Box sx={{ width: "40%" }}>
                                                ...
                                                <div className="Date-of-birth1">
                                                    <CustomDatePicker
                                                        ...
                                                        value={updateUserData.qualified_year ? new Date(updateUserData.qualified_year, 0, 1) : null}
                                                        onChange={(value) => {
                                                            if (value) {
                                                                const date = new Date(value);
                                                                setUpdateUserData({
                                                                    ...updateUserData,
                                                                    qualified_year: `${date.getFullYear()}`,
                                                                });
                                                            } else {
                                                                setUpdateUserData({
                                                                    ...updateUserData,
                                        ...
                                        <Box sx={{ width: " 40%" }}>
                                            ...
                                            <div className="reg-date1">
                                                <CustomDatePicker
                                                    ...
                                                    value={updateUserData.state_reg_date ? new Date(updateUserData.state_reg_date) : null}
                                                    onChange={(value) => {
                                                        if (value) {
                                                            const date = new Date(value);
                                                            setUpdateUserData({
                                                                ...updateUserData,
                                                                state_reg_date: `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(date.getDate()).padStart(2, '0')}`,
                                                            });
                                                        } else {
                                                            setUpdateUserData({
                                                                ...updateUserData,
                                            ...
                                            <div className="Registration-date">
                                                <CustomDatePicker
                                                    ...
                                                    value={updateUserData.country_reg_date ? new Date(updateUserData.country_reg_date) : null}
                                                    onChange={(value) => {
                                                        if (value) {
                                                            const date = new Date(value);
                                                            setUpdateUserData({
                                                                ...updateUserData,
                                                                country_reg_date: `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(date.getDate()).padStart(2, '0')}`,
                                                            });
                                                        } else {
                                                            setUpdateUserData({
                                                                ...updateUserData,
                                        ...
                                        <Box sx={{ width: "40%" }}>
                                            ...
                                            <div className="Registration-date">
                                                <CustomDatePicker
                                                    ...
                                                    value={updateUserData.lic_date ? new Date(updateUserData.lic_date) : null}
                                                    onChange={(value) => {
                                                        if (value) {
                                                            const date = new Date(value);
