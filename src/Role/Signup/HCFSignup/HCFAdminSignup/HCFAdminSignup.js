                                                ...
                                                <div className="Text-fields1">
                                                    <div style={{ display: "flex", justifyContent: "space-between", gap: "16px" }}>
                                                        <CustomDatePicker
                                                            ...
                                                            value={updateUserData.service_day_from ? new Date(updateUserData.service_day_from) : null}
                                                            onChange={(value) => {
                                                                if (value) {
                                                                    const date = new Date(value);
                                                                    setUpdateUserData({
                                                                        ...updateUserData,
                                                                        service_day_from: `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(date.getDate()).padStart(2, '0')}`,
                                                                    });
                                                                } else {
                                                                    setUpdateUserData({
                                                                        ...updateUserData,
                                                        ...
                                                        <CustomDatePicker
                                                            ...
                                                            value={updateUserData.service_day_to ? new Date(updateUserData.service_day_to) : null}
                                                            onChange={(value) => {
                                                                if (value) {
                                                                    const date = new Date(value);
                                                                    setUpdateUserData({
                                                                        ...updateUserData,
                                                                        service_day_to: `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(date.getDate()).padStart(2, '0')}`,
                                                                    });
                                                                } else {
                                                                    setUpdateUserData({
                                                                        ...updateUserData,
