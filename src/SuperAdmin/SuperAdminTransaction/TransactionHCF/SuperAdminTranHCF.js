...
import apolloimg from "../../../constants/DrImages/image 27.png";
...
const rows = [
    createData(
        <DoctorDetail image={apolloimg} name={"Dr. James k"} />,
        <Typography
            sx={{
                color: "#939094",
                fontFamily: "Poppins",
    ...
    createData(
        <DoctorDetail image={apolloimg} name={"Dr. Jennifer"} />,
        <Typography
            sx={{
                color: "#939094",
                fontFamily: "Poppins",
    ...
    createData(
        <DoctorDetail image={apolloimg} name={"Dr. Maria Gracia"} />,
        <Typography
            sx={{
                color: "#939094",
                fontFamily: "Poppins",
