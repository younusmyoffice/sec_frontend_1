...
const ChatBody = () => {
    ...
    return (
        <>
                            ...
                            >
                                <div style={{borderBottom:"1px solid #E6E1E5" , display : "flex" , justifyContent : "space-between"}}>
                                    <div style={{display:"flex"}}>
                                        <img src={img} style={{height:'50px', borderRadius:"10px"}} />
                                        <div style={{marginLeft:"10px"}}>
                                            <h3 style={{marginTop:"10px"}}>John Doe</h3>
                                            <p style={{color:"#e72b4a",marginTop:'-20px',fontSize:"small"}}>9:30 , 21/02/23</p>
                                        </div>
                                      
                                    </div>
                                    <div style={{display : "flex" , width : "15%"}} >
                                            <button style={{border: "1px solid #E6E1E5",borderRadius:"20px",height:"40px",width:"40px",textAlign:"center",margin:"auto",alignItems:"flex-end",background:"transparent"}}><WifiCalling3Icon style={{color:"#e72b4a",marginTop:"10px"}}/></button>
                                            <button style={{border: "1px solid #E6E1E5",borderRadius:"20px",height:"40px",width:"40px",textAlign:"center",margin:"auto",background:"transparent"}} onClick={() => navigate("videocall")}><VideoCallIcon style={{color:"#e72b4a",marginTop:"10px"}}/></button>
                                        </div>
                                </div>
                                ...
                                <div style={{textAlign:"center",margin:"auto",margin:"2%",}}>
                                    <div style={{background:"#EFEFEF",textAlign:"center",width:"20%",margin:"auto",borderRadius:"10px",color:"#AEAAAE"}}>Session Start</div>
                                ...
                                <div style={{borderTop:"1px solid #E6E1E5",marginTop:"210px",display:"flex"}}>
                               <input style={{border:'none',background:"#E6E1E5",padding:"5px",marginTop:"10px",width:"70%"}} placeholder="Type Here ..." />
                                ...
                                <div style={{background:"#E72B4A",textAlign:"start",width:"52%",color:"white",borderRadius:"10px",padding:"10px",display:"flex"}}>
