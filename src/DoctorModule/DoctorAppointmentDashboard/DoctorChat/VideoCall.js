...
import videocam from "../../../constants/DrImages/Videocam.svg"
import camera from "../../../constants/DrImages/Flip camera ios.svg"
            ...
            <div style={{ background: "#484649", height: '100%', display: "flex", gap: "1rem" }}>
                <div style={{ background: "#313033", width: "60%" }}>
                    ...
                    <div style={{textAlign:"center",marginTop:""}}>
                        <img src={john} style={{ borderRadius: "50%", height: "10%", width: "10%", marginTop: "20%" }} />
                    </div>
                    <h3 style={{ color: 'white',textAlign:"center"}}>John Doe</h3>
                    <p style={{ color: 'white',textAlign:"center" }}>Calling</p>
                    <div style={{ display: "flex", justifyContent: "center", gap: "1rem", marginTop: "5%" }}>
                        <button  onClick={handleClick} style={{background:"#484649",borderRadius:"50%",border:"none"}}>{state?<img src={mic}/>:<KeyboardVoiceIcon style={{color:"white"}} />}</button>
                        <button  onClick={handleCl} style={{background:"#484649",borderRadius:"50%",border:"none"}}>{video?<img src={videocam}/>:<VideocamIcon style={{color:"white"}} />}</button>
                        <button  onClick={handleCli} style={{background:"#484649",borderRadius:"50%",border:"none"}}>{cam?<img src={camera}/>:<FlipCameraIosIcon style={{color:"white"}} />}</button>
