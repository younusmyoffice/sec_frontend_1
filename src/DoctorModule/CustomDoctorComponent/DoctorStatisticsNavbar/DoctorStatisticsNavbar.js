...
const DoctorStatisticsNavbar = () => {
    return (
        <nav className="NavBar-Container-Appoinement">
            <NavLink to={"/doctordashboard/doctorStatistics/doctorBookingHistory"}>Booking History</NavLink>
            <NavLink to={"/doctordashboard/doctorStatistics/doctorTransaction"}>Transactions</NavLink>
